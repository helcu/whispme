...
public class ApiProvider {
    ...
    public static FollowService getFollowerService() {
        return NetworkClient.getClient(BASE_URL).create(FollowService.class);
    }

    public static FollowService getFollowingService() {
        return NetworkClient.getClient(BASE_URL).create(FollowService.class);
    }
}
